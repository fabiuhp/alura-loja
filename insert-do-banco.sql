  ...
  CREATE  TABLE  IF  NOT  EXISTS  public.produto_caracteristica
  (
  id uuid NOT NULL,
  nome character varying(100) COLLATE pg_catalog."default"  NOT NULL,
  descricao character varying(255) COLLATE pg_catalog."default"  NOT NULL,
  ...
  CONSTRAINT  "FK_67339e59ab4b3ed091cf318f426"  FOREIGN KEY ("produto_id")
  ...
  CONSTRAINT  "FK_eb1531605709dd94ec67b2141d0"  FOREIGN KEY ("produto_id")
  REFERENCES  public.produtos (id) MATCH SIMPLE
  ON  UPDATE CASCADE
  ON DELETE CASCADE
  );
